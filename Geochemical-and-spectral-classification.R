...
3. Extract clustering from models
...
lab = c("Manhattan7_w7","Manhattan8_w7","Manhattan9_w7","Manhattan10_w7","Manhattan7_w9","Manhattan8_w9","Manhattan9_w9","Manhattan10_w9","Mahalanobis7_w7","Mahalanobis8_w7","Mahalanobis9_w7","Mahalanobis10_w7","Mahalanobis7_w9","Mahalanobis8_w9","Mahalanobis9_w9","Mahalanobis10_w9")

v.measure_b = data.frame(lab)

v.measure_score = data.frame(v.measure_a, labels = v.measure_b)
colnames(v.measure_score) = c("V.Measure","Distance_&_window_size")
v.measure_score[,"V.Measure"] = round(v.measure_score[,"V.Measure"],digits =  3)

ggplot(v.measure_score, aes(x = V.Measure,y = Distance_&_window_size))+
